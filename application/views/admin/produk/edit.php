...
<div class="form-group">
  ...
  <div class="col-md-8">
    <select name="ukuran" class="form-control">
      ...
      <option value="M" <?php if ($produk->ukuran=="M") {echo "selected";} ?>>37</option>
      <option value="L" <?php if ($produk->ukuran=="L") {echo "selected";} ?>>38/39</option>
      <option value="XL" <?php if ($produk->ukuran=="XL") {echo "selected";} ?>>40/41</option>
      <option value="XXL" <?php if ($produk->ukuran=="XXL") {echo "selected";} ?>>42</option>
    </select>
  </div>
</div>
